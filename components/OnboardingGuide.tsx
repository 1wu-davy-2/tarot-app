      ...
      {open && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          >
            ...
            <button
              onClick={handleSkip}
              className="absolute top-4 right-4 z-10 p-1 text-mystic-rose/30 hover:text-mystic-rose"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="text-center pt-10 pb-6 px-8">
              ...
              <p className="text-sm text-mystic-rose/60 leading-relaxed">
                {STEPS[step].desc}
              </p>
            </div>
            ...
            <div className="flex items-center justify-between px-8 pb-8">
              <button
                onClick={handleSkip}
                className="text-xs text-mystic-rose/30 hover:text-mystic-rose/60"
              >
                跳过
              </button>
